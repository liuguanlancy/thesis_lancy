...
This chapter interprets the results in Chapter 4: what drives the mixture effects, the scaling behavior, and the transfer patterns. We then derive practical guidelines and note limits.
...
These points likely generalize beyond finance when facing the same trade‑offs: domain vs general data, mixture composition, model scaling, and format diversity, with local details varying by domain.
