...
\textbf{Key insight}. Mixed financial pretraining is the default choice for general‑purpose financial NLP. Robust across tasks. Scales well. See \Cref{tab:mixed_financial_results} for metrics by size and test set.
