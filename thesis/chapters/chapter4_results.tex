...
On the WikiText test set, the mixture achieves 27.72 ppl (4B). However, mean financial perplexity increases from 21.55 (pure financial; 4B) to $\sim$26.55 (Wiki+Financial; 4B, financial-only mean), a $\sim$23\% degradation. This trade-off is evident in \Cref{tab:mixed_wiki_financial_results}.
