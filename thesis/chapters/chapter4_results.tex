...
This chapter reports results from 10 pretraining experiments. The goal is to measure data-mixing effects in financial language models. We trained 30 models (3 sizes $\times$ 10 experiments) and ran 240 evaluations (30 models $\times$ 8 test sets). In short: Mixed Financial performs best on financial evaluation sets. Put another way, in-domain diversity beats general text in our setup. \Cref{tab:experiments_overview} summarizes the setup and headline numbers.
