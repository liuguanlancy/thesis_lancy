#!/usr/bin/env python3
"""
Generate pie chart for Mixed Wiki+Financial dataset (8 datasets) with 50cap strategy.
Shows token allocation from 100M budget. Raw corpus: 343.35M tokens.
"""
...
# Raw corpus: 343.35M tokens
final_sizes = {
    'News Articles': 39.7,
    'WikiText': 28.8,
    'Finance Alpaca': 8.3,
    'SEC Reports': 8.1,
    'FinGPT Sentiment': 5.8,
    'FiQA': 5.4,
    'Financial QA': 2.4,
    'Twitter Sentiment': 1.5
}
...
# Save
output_path = os.path.join(os.path.dirname(__file__), 'diagram_mixed_wiki.png')
plt.savefig(output_path, dpi=300, bbox_inches='tight')
print(f"✓ Saved Mixed Wiki+Financial pie chart to {output_path}")
print(f"  100M token budget (raw corpus: 343.35M)")
print(f"  News: 39.7M (39.7%), WikiText: 28.8M (28.8%)")
