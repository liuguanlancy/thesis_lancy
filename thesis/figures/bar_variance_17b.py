...
experiments = {
    'Alpaca': {'spread': 26.79, 'tokens': 8.46, 'epochs': 11.8},
    'FiQA': {'spread': 19.15, 'tokens': 3.60, 'epochs': 27.7},
    'SEC Reports': {'spread': 32.5, 'tokens': 8.12, 'epochs': 12.3},
    'Financial QA': {'spread': 24.29, 'tokens': 0.70, 'epochs': 142.7},
    'Twitter': {'spread': 50.44, 'tokens': 0.28, 'epochs': 351.7},
    'FinGPT': {'spread': 42.0, 'tokens': 4.14, 'epochs': 24.2},
    'WikiText': {'spread': 690.58, 'tokens': 123.58, 'epochs': 0.8},  # 1.7B spread - training collapse!
    'Mixed Financial': {'spread': 62.97, 'tokens': 219.77, 'epochs': 0.5},
    'Mixed Wiki+Fin': {'spread': 33.71, 'tokens': 343.35, 'epochs': 0.3},
    'News Articles': {'spread': 63.2, 'tokens': 194.47, 'epochs': 0.5},
}
...
ax.set_title('Cross-Dataset Variance at 1.7B Model Size\n(Lower = more consistent generalization)',
...
# Save
output_path = os.path.join(os.path.dirname(__file__), 'bar_variance_17b.png')
