...
These findings provide practical guidance for training privacy-preserving financial language models on local devices while contributing insights on data mixture strategies for 0.6B to 4B parameter models.
