...
Mixed financial datasets perform best for finance (21.55 perplexity at 4B), whereas general text pretraining trails behind (31.54 perplexity). All main runs used a learning rate of 2e-5; in a few unstable cases we lowered LR and training stabilized. Very small datasets (under 20K samples) overtrain and need mixing. WikiText helps little on finance, even though it is clean and well known.
