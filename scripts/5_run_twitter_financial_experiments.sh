#!/bin/bash
#
# Run Twitter Financial experiments for 3 different model sizes
...
echo "=========================================="
echo "Twitter Financial Pretraining Experiments"
echo "=========================================="
...
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 0.6b --experiments 5 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 4b --experiments 5 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 1.7b --experiments 5 \
...
echo ""
echo "Summary:"
echo "  ✓ 0.6B model trained on Twitter Financial"
echo "  ✓ 4B model trained on Twitter Financial"
echo "  ✓ 1.7B model trained on Twitter Financial"
echo ""
echo "Check the following directories for results:"
echo "  - runs/*_qwen3_0.6b/twitter_financial/"
echo "  - runs/*_qwen3_4b/twitter_financial/"
echo "  - runs/*_qwen3_1.7b/twitter_financial/"
echo "=========================================="