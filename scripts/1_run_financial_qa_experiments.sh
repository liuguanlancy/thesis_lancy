#!/bin/bash
#
# Run Financial Q&A experiments for 3 different model sizes
...
echo "=========================================="
echo "Financial Q&A Pretraining Experiments"
echo "=========================================="
...
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 0.6b --experiments 1 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 4b --experiments 1 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 1.7b --experiments 1 \
...
echo ""
echo "Summary:"
echo "  ✓ 0.6B model trained on Financial Q&A"
echo "  ✓ 4B model trained on Financial Q&A"
echo "  ✓ 1.7B model trained on Financial Q&A"
echo ""
echo "Check the following directories for results:"
echo "  - runs/*_qwen3_0.6b/financial_qa/"
echo "  - runs/*_qwen3_4b/financial_qa/"
echo "  - runs/*_qwen3_1.7b/financial_qa/"
echo "=========================================="