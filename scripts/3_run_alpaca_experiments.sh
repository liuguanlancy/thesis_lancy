#!/bin/bash
#
# Run Finance Alpaca experiments for 3 different model sizes
...
echo "=========================================="
echo "Finance Alpaca Pretraining Experiments"
echo "=========================================="
...
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 0.6b --experiments 3 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 4b --experiments 3 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 1.7b --experiments 3 \
...
echo ""
echo "Summary:"
echo "  ✓ 0.6B model trained on Finance Alpaca"
echo "  ✓ 4B model trained on Finance Alpaca"
echo "  ✓ 1.7B model trained on Finance Alpaca"
echo ""
echo "Check the following directories for results:"
echo "  - runs/*_qwen3_0.6b/alpaca/"
echo "  - runs/*_qwen3_4b/alpaca/"
echo "  - runs/*_qwen3_1.7b/alpaca/"
echo "=========================================="