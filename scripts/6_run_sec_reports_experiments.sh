#!/bin/bash
#
# Run SEC Reports experiments for 3 different model sizes
...
echo "=========================================="
echo "SEC Reports Pretraining Experiments"
echo "=========================================="
...
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 0.6b --experiments 6 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 4b --experiments 6 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 1.7b --experiments 6 \
...
echo ""
echo "Summary:"
echo "  ✓ 0.6B model trained on SEC Reports"
echo "  ✓ 4B model trained on SEC Reports"
echo "  ✓ 1.7B model trained on SEC Reports"
echo ""
