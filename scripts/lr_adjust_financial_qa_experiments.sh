#!/bin/bash
#
# Learning Rate Adjusted Financial Q&A experiments
...
#
# Note: Original experiments ran for 249 epochs, indicating severe overfitting
#
...
echo "=========================================="
echo "Financial Q&A LR-Adjusted Experiments"
echo "=========================================="
...
echo ""
echo "Original LR was 2e-5 (ran for 249 epochs!)"
...
$SCRIPT_DIR/phase2b_financial_pretraining.sh --experiments 1 \
...
echo "  - 1.7B: Should maintain ~2.1 loss (was 2.128)"
echo "  - 4B: Should improve to <2.1 loss (was 2.196)"
echo "  - Both: Should converge faster (original: 249 epochs!)"
echo ""
