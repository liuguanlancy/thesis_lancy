#!/bin/bash
#
# Run FinGPT Sentiment experiments for 3 different model sizes
...
echo "=========================================="
echo "FinGPT Sentiment Pretraining Experiments"
echo "=========================================="
...
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 0.6b --experiments 2 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 4b --experiments 2 \
...
echo "Time: $(date +"%Y-%m-%d %H:%M:%S")"
echo "----------------------------------------"
$SCRIPT_DIR/phase2b_rtx4090.sh --model 1.7b --experiments 2 \
...
echo ""
echo "Summary:"
echo "  ✓ 0.6B model trained on FinGPT Sentiment"
echo "  ✓ 4B model trained on FinGPT Sentiment"
echo "  ✓ 1.7B model trained on FinGPT Sentiment"
echo ""
